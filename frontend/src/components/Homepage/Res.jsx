...
const Res = () => {
  return (
    <div className='res-sec relative flex flex-col items-center	text-center p-[2%] 3xl:mt-[10vh] 2xl:mt-[10vh] xl:mt-[10vh] sm:mt-0 bg-green'>
        ...
        <div className='relative w-[85%] p-7 mb-5 grid grid-cols-2 gap-8 xl:grid-cols-1'>
            ...
            <div className='text-justify'>
              <ul className='text-xl list-disc py-5'>
                ...
                <p className='text-3xl text-center font-bold text-coffee'>"Unleash Flavorful Savings: BiteBliss, Where Every Bite Comes with a Delightful Discount!"</p>
            </div>
        </div>
        <Link to='/coupon-offers' className='absolute bg-coffee text-yellow p-3 rounded-lg bottom-5 right-8'>Coupon Offers</Link>
    </div>
  )
}
